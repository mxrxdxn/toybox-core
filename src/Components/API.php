...
class API
{
     ...
     */
    public static function addEndpoint(string $endpoint, Closure $callback, string $namespace = "toybox/v1", string $method = "GET"): void
    {
        ...
        add_action("rest_api_init", function () use ($namespace, $endpoint, $callback, $method) {
