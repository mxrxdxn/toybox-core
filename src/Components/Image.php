...
class Image
{
     ...
     *
     * @param WP_Post|int|null $post       The post object, ID, or null from which the thumbnail is retrieved. Defaults to null.
     ...
     */
    public static function makeResponsiveFromThumbnail(WP_Post|int|null $post = null, array $classes = ["toybox-responsive"], string $size = "full", array $attributes = []): string
    {
        if ($post === null) {
            $post = get_the_ID();
        }
